...
const ProjectCardHeader: FunctionComponent<ProjectCardHeaderProps> = ({project}) => {
	return (
		<div className="relative h-40">
			{/* Bolt: Added loading="lazy" to defer loading of project images as they are located below the fold.
			    This reduces initial page load time and improves overall performance. */}
