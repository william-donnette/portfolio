...
const Academic = () => {
	const education = [
		{
			...
			achievements: [
				...
				{
					description: 'Alternance Référent Technique SNCF Voyageurs (Projet Hastus)',
					links: [
						{
							category: 'Article',
				...
				{
					description: "Configuration sécurisée d'un serveur self-managed Debian avec déploiement de Docker.",
					links: [],
				},
				{
					description: "Développement de modèles d'IA en Machine Learning et Deep Learning",
					links: [
						{
				...
				{
					description: "Rédaction de rapports d'analyse et conception de stratégies S.I. ainsi que de cahier des charges",
					links: [],
				},
			],
		},
		{
			degree: "Licence Professionnelle Assistant de Projet Informatique, Développement d'Applications WEB/E-Buisness (APIDAE)",
			...
			achievements: [
				...
				{
					description: 'Adoption des méthodes agiles (Scrum, pair programming), des design patterns et du clean code.',
					links: [
						{
	...
	return (
		<Container id="academic">
			<h2 className="text-4xl font-bold text-center mb-12">Formation académique</h2>
			<div className="max-w-4xl mx-auto space-y-8">
				{education.map((edu, index) => (
					<div key={index} className="relative pl-8 border-l-2 border-blue-600">
						<div className="absolute -left-4 top-0">
							<div className="bg-blue-600 rounded-full p-2">{/* <GraduationCap className="w-4 h-4 text-white" /> */}</div>
						</div>
