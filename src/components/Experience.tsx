...
const Experience = () => {
	const experiences = [
		{
			...
			url: 'https://abes.fr/',
			period: '2024 - Present',
			description: "Maintenance et Développement de sites WEB de gestion bibliographiques de l'enseignement supérieur.",
			achievements: [
				{
				...
				{
					description: 'Développement de sites Front-End (TypeScript Vue.js)',
					links: [],
				},
				{
		...
		},
		{
			...
			achievements: [
				{
					description: "Développement d'un ETL interne (JavaScript Node.js)",
					links: [],
				},
				{
				...
				{
					description: 'Qualité de données (Collecte, Nettoyage, Standardisation)',
					links: [],
				},
				{
		...
		},
		{
			...
			achievements: [
				...
				{
					description: "Développement Front-End d'estimateur immobilier (JavaScript)",
					links: [],
				},
				{
					description: "Développement Back-End d'API d'estimation immobilière avec Machine Learning (PHP Laravel, RubixML)",
					links: [],
				},
				{
				...
				{
					description: 'Mise en place de WEB Analyse (Google Analytics, Google Tag Manager)',
					links: [],
				},
			],
		},
	...
	return (
		<Container id="experience">
			<h2 className="text-4xl font-bold text-center mb-12">Expériences Professionnelles</h2>
			<div className="max-w-4xl mx-auto space-y-8">
				{experiences.map((exp, index) => (
					<div key={index} className="relative pl-8 border-l-2 border-blue-600">
						<div className="absolute -left-4 top-0">
							<div className="bg-blue-600 rounded-full p-2">{/* <Briefcase className="w-4 h-4 text-white" /> */}</div>
						</div>
