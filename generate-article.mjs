...
async function main() {
	...
	const topics = [
		...
		"Événements Tech, Rencontres Couverture des événements technologiques et rencontres professionnelles dans l'Hérault, en France ou à l'international.",
		"Nature, Découvertes Exploration de la biodiversité et des paysages naturels de la région de l'Occitanie en France.",
